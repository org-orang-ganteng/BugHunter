---
name: performance
description: Skill untuk optimasi performa web agar loading lebih cepat & pengalaman pengguna lebih baik. Optimize web performance for faster loading and better user experience. Use when asked to "speed up my site", "optimize performance", "reduce load time", "fix slow loading", "improve page speed", or "performance audit".
license: MIT
metadata:
