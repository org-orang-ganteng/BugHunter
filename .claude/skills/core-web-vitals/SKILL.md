...
description: Skill untuk mengoptimalkan Core Web Vitals (LCP, INP, CLS) demi pengalaman halaman & peringkat pencarian lebih baik. Optimize Core Web Vitals (LCP, INP, CLS) for better page experience and search ranking. Use when asked to "improve Core Web Vitals", "fix LCP", "reduce CLS", "optimize INP", "page experience optimization", or "fix layout shifts".
license: MIT
metadata:
