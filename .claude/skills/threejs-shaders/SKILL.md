...
description: Skill untuk shader Three.js (GLSL, ShaderMaterial, uniform, efek kustom). Three.js shaders - GLSL, ShaderMaterial, uniforms, custom effects. Use when creating custom visual effects, modifying vertices, writing fragment shaders, or extending built-in materials.
---
