...
description: Skill untuk audit kualitas web menyeluruh (performa, aksesibilitas, SEO, praktik terbaik). Comprehensive web quality audit covering performance, accessibility, SEO, and best practices. Use when asked to "audit my site", "review web quality", "run lighthouse audit", "check page quality", or "optimize my website".
license: MIT
metadata:
