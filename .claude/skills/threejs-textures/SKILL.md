...
description: Skill untuk tekstur Three.js (jenis tekstur, UV mapping, environment map, pengaturan tekstur). Three.js textures - texture types, UV mapping, environment maps, texture settings. Use when working with images, UV coordinates, cubemaps, HDR environments, or texture optimization.
---
