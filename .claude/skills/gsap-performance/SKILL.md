...
description: Skill untuk optimasi performa animasi GSAP (utamakan transform, hindari layout thrashing, target 60fps mulus). Official GSAP skill for performance — prefer transforms, avoid layout thrashing, will-change, batching. Use when optimizing GSAP animations, reducing jank, or when the user asks about animation performance, FPS, or smooth 60fps.
license: MIT
---
