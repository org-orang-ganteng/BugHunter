...
description: Skill untuk material Three.js (PBR, basic, phong, shader material & propertinya). Three.js materials - PBR, basic, phong, shader materials, material properties. Use when styling meshes, working with textures, creating custom shaders, or optimizing material performance.
---
