---
name: gsap-utils
description: Skill untuk utilitas GSAP (clamp, mapRange, normalize, interpolate, random, snap, toArray, wrap). Official GSAP skill for gsap.utils — clamp, mapRange, normalize, interpolate, random, snap, toArray, wrap, pipe. Use when the user asks about gsap.utils, clamp, mapRange, random, snap, toArray, wrap, or helper utilities in GSAP.
license: MIT
---
