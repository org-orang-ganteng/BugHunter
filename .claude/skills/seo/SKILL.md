---
name: seo
description: Skill untuk optimasi SEO agar situs lebih terlihat & berperingkat di mesin pencari (meta tag, structured data, sitemap). Optimize for search engine visibility and ranking. Use when asked to "improve SEO", "optimize for search", "fix meta tags", "add structured data", "sitemap optimization", or "search engine optimization".
license: MIT
metadata:
