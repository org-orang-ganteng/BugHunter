---
name: best-practices
description: Skill untuk menerapkan praktik terbaik pengembangan web modern (keamanan, kompatibilitas, kualitas kode). Apply modern web development best practices for security, compatibility, and code quality. Use when asked to "apply best practices", "security audit", "modernize code", "code quality review", or "check for vulnerabilities".
license: MIT
metadata:
