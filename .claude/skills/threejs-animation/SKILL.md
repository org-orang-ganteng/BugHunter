...
description: Skill untuk animasi Three.js (keyframe, skeletal, morph target, mixing animasi). Three.js animation - keyframe animation, skeletal animation, morph targets, animation mixing. Use when animating objects, playing GLTF animations, creating procedural motion, or blending animations.
---
