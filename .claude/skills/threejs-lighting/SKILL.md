...
description: Skill untuk pencahayaan Three.js (jenis lampu, bayangan, pencahayaan lingkungan/IBL). Three.js lighting - light types, shadows, environment lighting. Use when adding lights, configuring shadows, setting up IBL, or optimizing lighting performance.
---
