...
name: design-dna
description: >-
  Skill untuk mengekstrak, mendefinisikan & menerapkan "design DNA" lewat tiga dimensi (design system, gaya desain, efek visual). Extract, define, and apply design DNA across three dimensions: design system
