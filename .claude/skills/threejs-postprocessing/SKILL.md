...
description: Skill untuk post-processing Three.js (EffectComposer, bloom, DOF, efek layar). Three.js post-processing - EffectComposer, bloom, DOF, screen effects. Use when adding visual effects, color grading, blur, glow, or creating custom screen-space shaders.
---
