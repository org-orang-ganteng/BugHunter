...
name: motion-design
description: >
  Skill untuk menerapkan prinsip motion design (timing, easing, koreografi, prinsip animasi Disney) pada UI. Applies motion design principles to create emotionally-driven, technically sound animations and transitions.
