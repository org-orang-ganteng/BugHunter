---
name: accessibility
description: Skill untuk audit & memperbaiki aksesibilitas web sesuai standar WCAG 2.2 (ramah screen reader & navigasi keyboard). Audit and improve web accessibility following WCAG 2.2 guidelines. Use when asked to "improve accessibility", "a11y audit", "WCAG compliance", "screen reader support", "keyboard navigation", or "make accessible".
license: MIT
metadata:
